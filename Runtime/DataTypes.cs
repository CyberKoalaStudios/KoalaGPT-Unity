...
namespace KoalaGPT
{
    ...
    public class KoalaGPTFileResponse : KoalaGPTFile, IResponse
    {
    ...
    public struct Auth
    {
        [Newtonsoft.Json.JsonRequired] public string ApiKey { get; set; }
    ...
    public struct ListModelsResponse : IResponse
    {
        public ApiError Error { get; set; }
        public string Object { get; set; }
        public List<KoalaGPTModel> Data { get; set; }
    }

    public class KoalaGPTModel
    {
        public string Id { get; set; }
        public string Object { get; set; }
    ...
    public class KoalaGPTModelResponse : KoalaGPTModel, IResponse
    {
        public ApiError Error { get; set; }
    }
    ...
    public struct SimpleText : IResponse
    {
        public ApiError Error { get; set; }
        public string Text { get; set; }
    }
    ...
    public struct ListFilesResponse : IResponse
    {
        public ApiError Error { get; set; }
        public string Object { get; set; }
        public List<KoalaGPTFile> Data { get; set; }
    }
    ...
    public class FineTune
    {
        ...
        public List<KoalaGPTFile> TrainingFiles { get; set; }
        public List<KoalaGPTFile> ValidationFiles { get; set; }
        public List<KoalaGPTFile> ResultFiles { get; set; }
