...
namespace KoalaGPT
{
    public static class ExtensionMethods
    {
        ...
        /// <param name="name">Name of the form field.</param>
        /// <param name="contentType">Content type of the file.</param>
        public static void AddData(this List<IMultipartFormSection> form, FileData data, string name,
            string contentType)
        {
        ...
        public static void SetHeaders(this UnityWebRequest request, Configuration configuration, string type = null)
        {
            ...
            {
                request.SetRequestHeader("CyberKoala-Organization", configuration.Auth.Organization);
            }
