    ...
    public class Configuration
    {
        ...
        public Configuration(string apiKey = null, string organization = null)
        {
            if (apiKey == null)
            {
                ...
                var authPath = $"{userPath}/.cyberkoala/auth.json";
                ...
                {
                    Debug.LogError(
                        "API Key is null and auth.json does not exist. Please check https://github.com/CyberKoalaStudios/KoalaGPT-Unity#saving-your-credentials");
                }
            }
            else
            {
